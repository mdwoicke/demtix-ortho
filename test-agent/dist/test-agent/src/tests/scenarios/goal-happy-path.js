...
exports.GOAL_HAPPY_001 = {
    ...
    constraints: [
        ...
        goal_test_1.PRESET_CONSTRAINTS.maxTurns(50),
    ],
...
exports.GOAL_HAPPY_002 = {
    ...
    constraints: [
        goal_test_1.PRESET_CONSTRAINTS.noErrors(),
        goal_test_1.PRESET_CONSTRAINTS.noInternalExposure(),
        goal_test_1.PRESET_CONSTRAINTS.maxTurns(50), // More turns for 2 children
    ],
    responseConfig: {
        maxTurns: 50,
...
exports.GOAL_HAPPY_003 = {
    ...
    constraints: [
        goal_test_1.PRESET_CONSTRAINTS.noErrors(),
        goal_test_1.PRESET_CONSTRAINTS.noInternalExposure(),
        goal_test_1.PRESET_CONSTRAINTS.maxTurns(50), // Verbose users need more turns
    ],
    responseConfig: {
        maxTurns: 50,
...
exports.GOAL_HAPPY_005 = {
    ...
    constraints: [
        goal_test_1.PRESET_CONSTRAINTS.noErrors(),
        goal_test_1.PRESET_CONSTRAINTS.noInternalExposure(),
        goal_test_1.PRESET_CONSTRAINTS.maxTurns(50), // May need more turns with terse user
    ],
    responseConfig: {
        maxTurns: 50,
        useLlmResponses: false,
