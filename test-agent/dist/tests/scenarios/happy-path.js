...
exports.happyPathScenarios = void 0;
        ...
        steps: [
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                // More flexible: agent may greet, ask clarifying questions, or directly engage
                semanticExpectations: [test_case_1.semanticExpectations.custom('Should engage with the scheduling request - greeting, asking questions, or acknowledging intent')],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.acknowledge()],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
            {
            ...
            },
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.acknowledge(), test_case_1.semanticExpectations.askForInfo('Should continue collecting patient info')],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.acknowledge(), test_case_1.semanticExpectations.askForInfo('Should continue with location or insurance')],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
            {
            ...
            },
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.acknowledge(), test_case_1.semanticExpectations.offerOptions()],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
            {
            ...
            },
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.custom('Should say goodbye professionally')],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
        ],
        expectations: [
        ...
        steps: [
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.greeting(), test_case_1.semanticExpectations.askForName()],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
            {
                id: 'step-2-provide-parent-info',
            ...
            },
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.acknowledge(), test_case_1.semanticExpectations.custom('Should ask for second child info')],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
            {
            ...
            },
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.acknowledge(), test_case_1.semanticExpectations.custom('Should acknowledge info and ask about time preference')],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
            {
            ...
            },
            {
                ...
                expectedPatterns: [/wonderful|goodbye|thank you|have a|great|scheduled|booked|address|confirmed|appointment|jake|lily/i],
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.custom('Should confirm booking with details OR say goodbye professionally')],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
        ],
        expectations: [
    ...
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.acknowledge(), test_case_1.semanticExpectations.custom('Should acknowledge the comprehensive info')],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
            {
                ...
                unexpectedPatterns: [test_case_1.patterns.error],
                semanticExpectations: [test_case_1.semanticExpectations.acknowledge(), test_case_1.semanticExpectations.askForInfo('Should continue with location or time')],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors()],
            },
            {
