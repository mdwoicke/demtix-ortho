...
class MarkdownReporter {
     ...
     */
    generateReport(run, results, recommendations) {
        const lines = [];
        // Header
    ...
    saveReport(content, filename) {
        const dir = path.resolve(process.cwd(), config_1.config.output.reportsDir);
     ...
     */
    generateTranscriptMarkdown(testId, transcript) {
        const lines = [];
