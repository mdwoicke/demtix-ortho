...
exports.INTENT_KEYWORDS = exports.INTENT_TO_FIELD = void 0;
exports.detectIntentByKeywords = detectIntentByKeywords;
/**
 * Mapping from intent to the collectable field it relates to
 */
exports.INTENT_TO_FIELD = {
 ...
 */
function detectIntentByKeywords(response) {
    // Check intents in priority order
    for (const intent of INTENT_PRIORITY_ORDER) {
        const patterns = exports.INTENT_KEYWORDS[intent];
