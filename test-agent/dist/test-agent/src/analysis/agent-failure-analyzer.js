...
class AgentFailureAnalyzer {
    ...
    async analyzeRun(runId, options = {}) {
        ...
        for (const context of failureContexts) {
            try {
                ...
                const generatedFixes = this.convertToGeneratedFixes(result.fixes, runId, context.testId, result.rootCause, result.classification);
    ...
    async analyzeTest(runId, testId, options = {}) {
        ...
        return this.convertToGeneratedFixes(result.fixes, runId, testId, result.rootCause, result.classification);
    }
    ...
    convertToGeneratedFixes(fixes, runId, testId, rootCause, classification) {
