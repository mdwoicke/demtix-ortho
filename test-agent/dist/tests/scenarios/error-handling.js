...
exports.errorHandlingScenarios = void 0;
...
exports.errorHandlingScenarios = [
    {
        id: 'ERR-001',
        ...
        steps: [
            {
                ...
                unexpectedPatterns: [],
                semanticExpectations: [test_case_1.semanticExpectations.handleError()],
                negativeExpectations: [test_case_1.negativeExpectations.noErrors(), test_case_1.negativeExpectations.noInternalDetails()],
